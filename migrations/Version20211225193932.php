 ...
 */
final class Version20211225193932 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE borrowing (id INT AUTO_INCREMENT NOT NULL, lend_by_id INT NOT NULL, borrowed_by_id INT NOT NULL, equipment_id INT NOT NULL, started_on DATETIME NOT NULL, ended_on DATETIME NOT NULL, allowad_days INT NOT NULL, remarks LONGTEXT DEFAULT NULL, INDEX IDX_226E58971520FF27 (lend_by_id), INDEX IDX_226E589739759382 (borrowed_by_id), INDEX IDX_226E5897517FE9FE (equipment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
